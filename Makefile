...
GOLD_SRCS := goldilocks.cu fr-tensor.cu proof.cu polynomial.cu ioutils.cu ntt.cu merkle.cu
...
# Clean rule
clean:
	rm -f $(TARGET_OBJS) $(CU_OBJS) $(CPP_OBJS) $(TARGETS) test_goldilocks test_goldilocks.o goldilocks.o $(GOLD_OBJS) gold_test_gold_tensor.o test_gold_tensor gold_test_ntt.o test_ntt gold_test_merkle.o test_merkle
